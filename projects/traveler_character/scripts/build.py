...
def vest_gap(z):
    if z<2.20:
        return 0.38
    return min(0.62,0.38+(z-2.20)*0.46)

vest=torso_arc(
    "Traveler_Vest",
    [1.50,1.64,1.82,2.02,2.22,2.40,2.56,2.68,2.75],
    0.040,vest_mat,vest_gap,segments=72,thickness=0.020
)
